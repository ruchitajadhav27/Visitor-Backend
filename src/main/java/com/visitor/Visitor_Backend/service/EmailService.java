    ...
    public void sendVisitorStatusEmail(Appointment appointment) {
        ...
        try {
            ...
            if (status.equalsIgnoreCase("Approved")) {
                ...
                statusMessage =
                        "Kindly reach 5 mins before time.";
                ...
                statusMessage =
                        "Unfortunately, your request could not be accommodated at this time.";
            }
                ...
                statusMessage =
                        "Thank you for visiting! We hope you had a productive meeting.";
                ...
                statusMessage =
                        "It looks like you missed your appointment.";

                actionHtml =
                        "<a href='http://localhost:5173/my-meetings?reschedule="
                                + appointment.getId()
            ...
            String emailBody =
                    "<div style='font-family: Arial, sans-serif; color: #334155; line-height: 1.6; max-width: 600px; margin: 0; padding: 20px;'>" +
                            ...
                            "<h2 style='color: #0f172a; font-size: 20px;'>Hello "
                            ...
                            "<p style='margin: 5px 0; color: #64748b;'><strong>Host:</strong> <span style='color: #0f172a;'>"
                            + appointment.getWhomToMeet()
                            + "</span></p>" +

                            "<p style='margin: 5px 0; color: #64748b;'><strong>Date:</strong> <span style='color: #0f172a;'>"
                            + appointment.getDate()
                            + "</span></p>" +

                            "<p style='margin: 5px 0; color: #64748b;'><strong>Time:</strong> <span style='color: #0f172a;'>"
                            + appointment.getTimeIn()
                            + " - "
                            + appointment.getTimeOut()
                            + "</span></p>" +

                            "<p style='margin: 5px 0; color: #64748b;'><strong>Purpose:</strong> <span style='color: #0f172a;'>"
                            ...
                            + "Sent via MeetIn Management System • "
                            + currentTime
                            + "</div>" +
    ...
    private String generateActionButtons(
        ...
        return
                "<a href='"
                        ...
                        + "/confirm/"
                        + appointmentId
                        + "' style='text-decoration: none; color: #10b981; font-weight: bold; margin-right: 15px;'>CONFIRM</a>"
                        ...
                        + "?reschedule="
                        + appointmentId
                        + "' style='text-decoration: none; color: #3b82f6; font-weight: bold; margin-right: 15px;'>RESCHEDULE</a>"
                        ...
                        + "/cancel/"
                        + appointmentId
                        + "' style='text-decoration: none; color: #ef4444; font-weight: bold;'>CANCEL</a>";
    }
}